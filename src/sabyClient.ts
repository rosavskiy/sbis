...
export interface SabyAuthConfig {
  baseUrl: string;
  login: string;
  password: string;
}
...
export interface UploadMeta {
  // TODO: уточнить структуру по доке Saby (тип документа, контрагент и т.п.)
  [key: string]: unknown;
}
...
export class SabyClient {
  ...
  constructor(private config: SabyAuthConfig) {}
  ...
  async uploadDraftDocument(meta: UploadMeta, fileBuffer: Buffer, fileName: string) {
